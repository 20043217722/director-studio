...
### 🎥 机位语法库（替代前景/中景/背景的简单分层·空间关系必须用导演语法表达）

> **禁止只用"前景虚化/主体/陪体/背景"描述空间。每镜必须用以下机位语法明确：摄影机在哪·过谁的肩·拍谁的脸·双方视线的轴线关系。**
...
- 180度轴线: 摄影机不能跨越两人连线的轴线，否则视线方向会反转，观众会感觉两人"看错了方向"

#### 三、打戏对峙空间关系

格式: `攻方[位置·朝向] vs 守方[位置·朝向]·轴线[描述]·机位[描述]`

✅ 正确: "陈默在画面左侧·身体前倾·右手持剑指向画面右侧。老周在画面右侧·重心后移·左手挡在胸前。两人连线的轴线水平横穿画面，摄影机在轴线下方低机位仰拍——陈默显得居高临下（攻方），老周被压迫（守方）"
❌ 错误: "两人对峙"
...
格式: `[权力中心]在画面[位置]·[从属人物]在[位置]·视线汇聚[方向]`

✅ 正确: "老周坐在画面正中的主位，其他三人分坐两侧形成半弧，所有人的视线都汇聚到老周——画面构图就是权力结构"
❌ 错误: "四个人在房间里"
...
| 机位高度 | 空间含义 | 何时使用 |
|------|------|------|
| 低机位仰拍 | 支配·压迫·权威 | 攻方·权力人物·威胁逼近 |
| 高机位俯拍 | 无力·弱势·被压制 | 守方·受害者·困境 |
| 平视 | 平等·对话·对峙 | 双人平等对峙·谈判 |
| 极低机位 | 英雄化·史诗感 | 主角登场·重大决定 |
| 极俯拍 | 宿命感·棋子感 | 角色被命运操控·无力反抗 |
